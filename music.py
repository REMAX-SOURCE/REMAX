...
async def play(c: Client, m: Message):
    ...
    try:
        ...
        return await m.reply_text(f"خطـأ:\n\n{e}")
    ...
    try:
        ...
        if m.chat.username:
            try:
                ...
                await m.reply_text(f"❌ **فشـل الحسـاب المسـاعد في الانضمام**\n\n**السبب**: `{e}`")
                return
        else:
            try:
                ...
                return await m.reply_text(
                    f"❌ **فشـل الحسـاب المسـاعد في الانضمام**\n\n**السبب**: `{e}`"
                )
