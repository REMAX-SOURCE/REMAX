        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "قناة السـورس", url=f"https://t.me/REMAX_SOURCE"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "لتنصيب بوت", url="https://t.me/­­­WQ_SI"
                    )
                ],
            ]
        ),
...
async def cbguides(_, query: CallbackQuery):
 ...
 ⚡ ادارة سـورس ­­­ريمـاكـس ⁞♩𝗥𝗘𝗠𝗔𝗫 @REMAX_SOURCE
__""",
        reply_markup=InlineKeyboardMarkup(
...
⚡ __Powered by {BOT_NAME} A.I__""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("👷🏻 اوامـر الادمـن", callback_data="cbadmin"),
                    InlineKeyboardButton("🧙🏻 اوامـر المطـور", callback_data="cbsudo"),
                ],[
                    InlineKeyboardButton("📚 اوامـر اسـاسيـه", callback_data="cbbasic")
                ],[
...
» /vunmute لرفع الكتم عن البوت
 ⚡ ادارة سـورس ­­­ريمـاكـس ⁞♩𝗥𝗘𝗠𝗔𝗫 @­­­WQ_SI
__""",
        reply_markup=InlineKeyboardMarkup(
